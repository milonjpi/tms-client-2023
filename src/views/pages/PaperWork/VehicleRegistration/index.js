...
import VehicleRegistrationRow from './VehicleRegistrationRow';
        ...
        <Table sx={{ minWidth: 400 }}>
          <TableHead>
            <StyledTableRow>
              ...
              <StyledTableCell>Reg. Date</StyledTableCell>
          ...
          <TableBody>
            {allPaperWorks?.length ? (
              allPaperWorks.map((item) => (
                <VehicleRegistrationRow key={item.id} sn={sn++} data={item} />
              ))
            ) : (
              <StyledTableRow>
                <StyledTableCell colSpan={11} sx={{ border: 0 }} align="center">
                  {isLoading ? (
